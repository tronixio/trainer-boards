...
- [1.PIC16F1773/6/8 Module SPI NHD-C21832A1Z-RGB.](#1pic16f177368-module-spi-nhd-c21832a1z-rgb)

## 1.PIC16F1773/6/8 Module SPI NHD-C21832A1Z-RGB.
...
// Module SPI - LCD Character - NHD-C12832A1Z RGB - ST7565R.
...
#define C12832A1Z_BACKLIGHT_BLUE_OFF                            do{LATAbits.LATA1 = 0b0;} while(0)
#define C12832A1Z_BACKLIGHT_BLUE_ON                             do{LATAbits.LATA1 = 0b1;} while(0)
#define C12832A1Z_BACKLIGHT_GREEN_OFF                           do{LATAbits.LATA2 = 0b0;} while(0)
#define C12832A1Z_BACKLIGHT_GREEN_ON                            do{LATAbits.LATA2 = 0b1;} while(0)
#define C12832A1Z_BACKLIGHT_RED_OFF                             do{LATAbits.LATA3 = 0b0;} while(0)
#define C12832A1Z_BACKLIGHT_RED_ON                              do{LATAbits.LATA3 = 0b1;} while(0)
#define C12832A1Z_BACKLIGHT_OFF                                 0
#define C12832A1Z_BACKLIGHT_RED                                 1
#define C12832A1Z_BACKLIGHT_GREEN                               2
#define C12832A1Z_BACKLIGHT_BLUE                                3
#define C12832A1Z_BACKLIGHT_YELLOW                              4
#define C12832A1Z_BACKLIGHT_CYAN                                5
#define C12832A1Z_BACKLIGHT_PURPLE                              6
#define C12832A1Z_BACKLIGHT_WHITE                               7
// Battery Patterns.
...
void lcd_backlightColor(uint8_t u8Color);
...
void main(void)
{
    ...
    uint8_t u8Backlight = 0;
    while(1){
        lcd_backlightColor(u8Backlight++);
        if(u8Backlight==8) u8Backlight = 0;
        __delay_ms(3000);
    }
}
...
void lcd_backlightColor(uint8_t u8Color)
{
    switch(u8Color)
    {
        case C12832A1Z_BACKLIGHT_RED:
            C12832A1Z_BACKLIGHT_RED_ON;
            C12832A1Z_BACKLIGHT_GREEN_OFF;
            C12832A1Z_BACKLIGHT_BLUE_OFF;
            break;
        case C12832A1Z_BACKLIGHT_GREEN:
            C12832A1Z_BACKLIGHT_RED_OFF;
            C12832A1Z_BACKLIGHT_GREEN_ON;
            C12832A1Z_BACKLIGHT_BLUE_OFF;
            break;
        case C12832A1Z_BACKLIGHT_BLUE:
            C12832A1Z_BACKLIGHT_RED_OFF;
            C12832A1Z_BACKLIGHT_GREEN_OFF;
            C12832A1Z_BACKLIGHT_BLUE_ON;
            break;
        case C12832A1Z_BACKLIGHT_YELLOW:
            C12832A1Z_BACKLIGHT_RED_ON;
            C12832A1Z_BACKLIGHT_GREEN_ON;
            C12832A1Z_BACKLIGHT_BLUE_OFF;
            break;
        case C12832A1Z_BACKLIGHT_CYAN:
            C12832A1Z_BACKLIGHT_RED_OFF;
            C12832A1Z_BACKLIGHT_GREEN_ON;
            C12832A1Z_BACKLIGHT_BLUE_ON;
            break;
        case C12832A1Z_BACKLIGHT_PURPLE:
            C12832A1Z_BACKLIGHT_RED_ON;
            C12832A1Z_BACKLIGHT_GREEN_OFF;
            C12832A1Z_BACKLIGHT_BLUE_ON;
            break;
        case C12832A1Z_BACKLIGHT_WHITE:
            C12832A1Z_BACKLIGHT_RED_ON;
            C12832A1Z_BACKLIGHT_GREEN_ON;
            C12832A1Z_BACKLIGHT_BLUE_ON;
            break;
