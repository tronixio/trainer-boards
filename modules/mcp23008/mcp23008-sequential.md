# TODO - MCP23008 Sequential Mode.

## Contents.

- [1.TODO - PIC16F1773/6/8 Module I2C MCP23008 LED.](#1todo---pic16f177368-module-i2c-mcp23008-led)
- [2.TODO - PIC16F1773/6/8 Module I2C MCP23008 Switch with Polling.](#2todo---pic16f177368-module-i2c-mcp23008-switch-with-polling)
- [3.TODO - PIC16F1773/6/8 Module I2C MCP23008 Switch with Timer Interrupts Polling.](#3todo---pic16f177368-module-i2c-mcp23008-switch-with-timer-interrupts-polling)
- [4.TODO - PIC16F1773/6/8 Module I2C MCP23008 Switch with Interrupts.](#4todo---pic16f177368-module-i2c-mcp23008-switch-with-interrupts)
- [5.TODO - PIC16F1773/6/8 Module I2C MCP23008 Header.](#5todo---pic16f177368-module-i2c-mcp23008-header)
...
// Module I2C MCP23008 LED Sequential Mode.
...
void main(void)
{
    ...
    while(1){
        for(u8Repeat=0; u8Repeat<5; u8Repeat++){
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0x01);
            __delay_ms(DELAY);
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0x03);
            __delay_ms(DELAY);
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0x07);
            __delay_ms(DELAY);
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0x0F);
            __delay_ms(DELAY);
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0x1F);
            __delay_ms(DELAY);
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0x3F);
            __delay_ms(DELAY);
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0x7F);
            __delay_ms(DELAY);
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0xFF);
            __delay_ms(DELAY);

            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0xFE);
            __delay_ms(DELAY);
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0xFC);
            __delay_ms(DELAY);
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0xF8);
            __delay_ms(DELAY);
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0xF0);
            __delay_ms(DELAY);
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0xE0);
            __delay_ms(DELAY);
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0xC0);
            __delay_ms(DELAY);
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0x80);
            __delay_ms(DELAY);
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0x00);
            __delay_ms(DELAY);
        }
        ...
        for(u8Repeat=0; u8Repeat<5; u8Repeat++){
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0x01);
            __delay_ms(DELAY);
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0x02);
            __delay_ms(DELAY);
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0x04);
            __delay_ms(DELAY);
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0x08);
            __delay_ms(DELAY);
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0x10);
            __delay_ms(DELAY);
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0x20);
            __delay_ms(DELAY);
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0x40);
            __delay_ms(DELAY);
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0x80);
            __delay_ms(DELAY);
        ...
        for(u8Repeat=0; u8Repeat<10; u8Repeat++){
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0x55);
            __delay_ms(DELAY);
            mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO, 0xAA);
            __delay_ms(DELAY);
        }
    }
}
...
## 2.TODO - PIC16F1773/6/8 Module I2C MCP23008 Switch with Polling.
...
// Module I2C MCP23008 Switch Sequential Mode.
...
void main(void)
{
    ...
    // MCP23008 Initialization.
    mcp23008_initialize(MCP23008_CONFIGURATION_I2C_ADDRESS);
    mcp23008_writeRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPINTEN, 0b11111111);
    ...
    while(1){
        if(PORTCbits.RC1){
            LATB = mcp23008_readRegister(MCP23008_CONFIGURATION_I2C_ADDRESS, MCP23008_GPIO);
        }
    }
}
...
## 3.TODO - PIC16F1773/6/8 Module I2C MCP23008 Switch with Timer Interrupts Polling.
...
## 4.TODO - PIC16F1773/6/8 Module I2C MCP23008 Switch with Interrupts.
...
## 5.TODO - PIC16F1773/6/8 Module I2C MCP23008 Header.
...
<p align="center"><img alt=="MCP23008 Header Sequential Mode" src="./pics/mcp23008-sequential.png"></p>
