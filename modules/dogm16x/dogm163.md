...
- [1.PIC16F1773/6/8 Module EA-DOGM163 - 4-Bit - 3V3.](#1pic16f177368-module-ea-dogm163---4-bit---3v3)
- [2.PIC16F1773/6/8 Module EA-DOGM163 - 8-Bit - 3V3.](#2pic16f177368-module-ea-dogm163---8-bit---3v3)
- [3.PIC16F1773/6/8 Module EA-DOGM163 - SPI - 3V3.](#3pic16f177368-module-ea-dogm163---spi---3v3)
- [4.PIC16F1773/6/8 Module EA-DOGM163 - 4-Bit - 5V.](#4pic16f177368-module-ea-dogm163---4-bit---5v)
- [5.PIC16F1773/6/8 Module EA-DOGM163 - 8-Bit - 5V.](#5pic16f177368-module-ea-dogm163---8-bit---5v)
- [6.PIC16F1773/6/8 Module EA-DOGM163 - SPI - 5V.](#6pic16f177368-module-ea-dogm163---spi---5v)

## 1.PIC16F1773/6/8 Module EA-DOGM163 - 4-Bit - 3V3.
...
// Module - LCD Character - EA-DOGM163 - ST7036.
// 3 Lines, 8 Characters, 3V3, 4 Bits.
...
#define ST7036_DDRAM_ADDRESS_SECOND_LINE                   0x90
#define ST7036_DDRAM_ADDRESS_THIRD_LINE                    0xA0
...
#define DOGM_CONFIGURATION_THIRD_LINE                      ST7036_DDRAM_ADDRESS_THIRD_LINE
...
const uint8_t au8Dogm[] = "EA-DOGM163";
...
void main(void)
{
    ...
    lcd_writeStringSetCursor(au8Dogm, DOGM_CONFIGURATION_THIRD_LINE);
...
void lcd_initialization(void)
{
    ...
    lcd_writeInstruction(ST7036_FUNCTION_SET_4_BIT_ONE_LINE_FONT5x8_IS1);
    lcd_writeInstruction(ST7036_BIAS_SET_1_5_3_LINE);
...
## 2.PIC16F1773/6/8 Module EA-DOGM163 - 8-Bit - 3V3.
...
// Module - LCD Character - EA-DOGM163 - ST7036.
// 3 Lines, 8 Characters, 3V3, 8 Bits.
// Strings & Patterns - v0.1 - 05/2020.
...
## 3.PIC16F1773/6/8 Module EA-DOGM163 - SPI - 3V3.
...
void lcd_initialization(void)
{
    ...
    u8Dummy = SSPBUF;
    SSPBUF = ST7036_BIAS_SET_1_5_3_LINE;
    while(!SSPSTATbits.BF){};
    u8Dummy = SSPBUF;
...
## 4.PIC16F1773/6/8 Module EA-DOGM163 - 4-Bit - 5V.
...
// Module - LCD Character - EA-DOGM163 - ST7036.
// 3 Lines, 8 Characters, 5V, 4 Bits.
// Strings & Patterns - v0.1 - 05/2020.
...
void lcd_initialization(void)
{
    ...
    lcd_writeInstruction(ST7036_FUNCTION_SET_4_BIT_ONE_LINE_FONT5x8_IS1);
    lcd_writeInstruction(ST7036_FUNCTION_SET_4_BIT_ONE_LINE_FONT5x8_IS1);
    lcd_writeInstruction(ST7036_BIAS_SET_1_4_3_LINE);
    lcd_writeInstruction(ST7036_CONTRAST_LSB_7);
...
## 5.PIC16F1773/6/8 Module EA-DOGM163 - 8-Bit - 5V.
...
// Module - LCD Character - EA-DOGM163 - ST7036.
// 3 Lines, 8 Characters, 5V, 8 Bits.
// Strings & Patterns - v0.1 - 05/2020.
...
## 6.PIC16F1773/6/8 Module EA-DOGM163 - SPI - 5V.
...
void lcd_initialization(void)
{
    ...
    while(!SSPSTATbits.BF){};
    u8Dummy = SSPBUF;
    SSPBUF = ST7036_BIAS_SET_1_4_3_LINE;
    while(!SSPSTATbits.BF){};
    u8Dummy = SSPBUF;
    SSPBUF = ST7036_CONTRAST_LSB_7;
    while(!SSPSTATbits.BF){};
