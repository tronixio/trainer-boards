...
- [1.PIC16F1773/6/8 Module EA-DOGM081 - 4-Bit - 3V3.](#1pic16f177368-module-ea-dogm081---4-bit---3v3)
- [2.PIC16F1773/6/8 Module EA-DOGM081 - 8-Bit - 3V3.](#2pic16f177368-module-ea-dogm081---8-bit---3v3)
- [3.PIC16F1773/6/8 Module EA-DOGM081 - SPI - 3V3.](#3pic16f177368-module-ea-dogm081---spi---3v3)
- [4.PIC16F1773/6/8 Module EA-DOGM081 - 4-Bit - 5V.](#4pic16f177368-module-ea-dogm081---4-bit---5v)
- [5.PIC16F1773/6/8 Module EA-DOGM081 - 8-Bit - 5V.](#5pic16f177368-module-ea-dogm081---8-bit---5v)
- [6.PIC16F1773/6/8 Module EA-DOGM081 - SPI - 5V.](#6pic16f177368-module-ea-dogm081---spi---5v)

## 1.PIC16F1773/6/8 Module EA-DOGM081 - 4-Bit - 3V3.
...
// Module - LCD Character - EA-DOGM081 - ST7036.
// 1 Line, 8 Characters, 3V3, 4 Bits.
...
#define DOGM_CONFIGURATION_CHARACTERS                      8
...
const uint8_t au8Tronix[] = "Tronix";
...
void main(void)
{
    ...
    while(1){
        for(pattern=0; pattern<5; pattern++){
            lcd_writeInstruction(DOGM_CONFIGURATION_FIRST_LINE + 0x07);
...
void lcd_initialization(void)
{
    ...
    lcd_writeInstruction(ST7036_FUNCTION_SET_4_BIT_ONE_LINE_FONT5x8);
...
## 2.PIC16F1773/6/8 Module EA-DOGM081 - 8-Bit - 3V3.
...
// Module - LCD Character - EA-DOGM081 - ST7036.
// 1 Line, 8 Characters, 3V3, 8 Bits.
// Strings & Patterns - v0.1 - 05/2020.
...
void lcd_initialization(void)
{
    ...
    lcd_writeInstruction(ST7036_FOLLOWER_CONTROL_ON_RAB_4);
    // Instruction Table IS2=0, IS1=0.
    lcd_writeInstruction(ST7036_FUNCTION_SET_8_BIT_ONE_LINE_FONT5x8);
    lcd_writeInstruction(ST7036_DISPLAY_ON_CURSOR_OFF);
    lcd_writeInstruction(ST7036_CLEAR_DISPLAY);
    __delay_ms(ST7036_CLEAR_DISPLAY_DELAY_MS);
    lcd_writeInstruction(ST7036_ENTRY_MODE_SET_DDRAM_INCREMENT_NOSHIFT);
...
## 3.PIC16F1773/6/8 Module EA-DOGM081 - SPI - 3V3.
...
void lcd_initialization(void)
{
    ...
    u8Dummy = SSPBUF;
    // Instruction Table IS2=0, IS1=0.
    SSPBUF = ST7036_FUNCTION_SET_8_BIT_ONE_LINE_FONT5x8;
    while(!SSPSTATbits.BF){};
    u8Dummy = SSPBUF;
...
## 4.PIC16F1773/6/8 Module EA-DOGM081 - 4-Bit - 5V.
...
void lcd_initialization(void)
{
    ...
    lcd_writeInstruction(ST7036_FOLLOWER_CONTROL_ON_RAB_3);
    // Instruction Table IS2=0, IS1=0.
    lcd_writeInstruction(ST7036_FUNCTION_SET_4_BIT_ONE_LINE_FONT5x8);
    lcd_writeInstruction(ST7036_DISPLAY_ON_CURSOR_OFF);
    lcd_writeInstruction(ST7036_CLEAR_DISPLAY);
...
## 5.PIC16F1773/6/8 Module EA-DOGM081 - 8-Bit - 5V.
...
## 6.PIC16F1773/6/8 Module EA-DOGM081 - SPI - 5V.
...
void lcd_initialization(void)
{
    ...
    while(!SSPSTATbits.BF){};
    u8Dummy = SSPBUF;
    SSPBUF = ST7036_FOLLOWER_CONTROL_ON_RAB_3;
    while(!SSPSTATbits.BF){};
    u8Dummy = SSPBUF;
    // Instruction Table IS2=0, IS1=0.
    SSPBUF = ST7036_FUNCTION_SET_8_BIT_ONE_LINE_FONT5x8;
